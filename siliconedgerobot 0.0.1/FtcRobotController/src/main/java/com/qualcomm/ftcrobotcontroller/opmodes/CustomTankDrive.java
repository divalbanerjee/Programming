...
//FIXME this will cause a problem when transitioning to git, a separate branch may be needed.
public class CustomTankDrive extends K9TankDrive {
    ...
    public void loop()
    {
        ...
        //get values for each side using one joystick
        //basic formula from Team 7612 code
        //TODO confirm this formula with testing
        float left = -gamepad1.left_stick_y + gamepad1.left_stick_x;
        float right = -gamepad1.left_stick_y - gamepad1.left_stick_x;

        //scale down the motor output to prevent burnout
        left *= 0.9;
        right *= 0.9;
